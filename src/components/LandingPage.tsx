...
export const LandingPage: React.FC<LandingPageProps> = ({ onOpenAuth, appLogo }) => {
  ...
  const [estimatedFollowers, setEstimatedFollowers] = useState<number>(25000);
  const [activeScreenshotTab, setActiveScreenshotTab] = useState<string>('Home');
  const [faqOpenIndex, setFaqOpenIndex] = useState<number | null>(null);
  
  // Simulated counters
  const [liveOnlineUsers, setLiveOnlineUsers] = useState<number>(14334);
  const [downloadCount, setDownloadCount] = useState<number>(48193291);
  ...
  const notificationsList = [
    { id: 1, text: "Ali sent you 200 Coins! 🪙", icon: "🪙", time: "Just now" },
    { id: 2, text: "Zara is Live Streaming! 🎥", icon: "🔥", time: "1m ago" },
    { id: 3, text: "Hassan uploaded a new Reel!", icon: "✨", time: "3m ago" },
    { id: 4, text: "New Marketplace order received!", icon: "🛍️", time: "5m ago" }
  ];
  ...
  const features = [
    ...
    { id: "voice_calls", title: "HD Voice Calls", desc: "Crystal clear audio.", icon: PhoneCall, color: "text-blue-500", bg: "bg-blue-500/10" },
    { id: "video_calls", title: "HD Video Calls", desc: "Unlimited video calls.", icon: Video, color: "text-cyan-500", bg: "bg-cyan-500/10" },
    { id: "groups", title: "Groups", desc: "Create communities.", icon: Users, color: "text-emerald-500", bg: "bg-emerald-500/10" },
    { id: "channels", title: "Channels", desc: "Broadcast to unlimited followers.", icon: Radio, color: "text-indigo-500", bg: "bg-indigo-500/10" },
    ...
    { id: "live_streaming", title: "Live Streaming", desc: "Go live anytime.", icon: Activity, color: "text-orange-500", bg: "bg-orange-500/10" },
    { id: "marketplace", title: "Marketplace", desc: "Buy and sell.", icon: ShoppingBag, color: "text-yellow-500", bg: "bg-yellow-500/10" },
    { id: "wallet", title: "Wallet", desc: "Receive payments.", icon: Wallet, color: "text-teal-500", bg: "bg-teal-500/10" },
    { id: "monetization", title: "Monetization", desc: "Earn money from content.", icon: DollarSign, color: "text-amber-500", bg: "bg-amber-500/10" },
    { id: "ai_assistant", title: "AI Assistant", desc: "Built-in AI.", icon: Brain, color: "text-indigo-400", bg: "bg-indigo-400/10" },
    ...
    { id: "translation", title: "Translation", desc: "Translate all messages instantly.", icon: Languages, color: "text-emerald-400", bg: "bg-emerald-400/10" },
    { id: "encryption", title: "End-to-End Encryption", desc: "Maximum privacy.", icon: Lock, color: "text-cyan-400", bg: "bg-cyan-400/10" },
  ];
  ...
  const appScreenshots = [
    ...
    { id: "Calls", title: "HD Calls", desc: "High definition crystal-clear voice and video calling.", imageText: "📞 High Definition Connection 📞\n• Zero-lag video streaming calls\n• Intelligent background noise cancellation\n• Interactive screen sharing\n• Encrypted call history", bg: "bg-gradient-to-br from-blue-950 to-[#141b2d]" },
  ...
  const testimonials = [
    { name: "Saciid Axmed", role: "Content Creator, Hargeisa", text: "SomLuul completely changed how I make content. The monetization system is instant and the coin gifts are highly rewarding! 🇸🇴", stars: 5 },
    { name: "Hibo Maxamed", role: "E-Commerce Business, Mogadishu", text: "I list my fashion inventory on SomLuul Marketplace and communicate with clients on the encrypted Messenger. Absolutely brilliant!", stars: 5 },
    { name: "Cabdi Qadar", role: "Software Developer, Garowe", text: "The cloud storage integration, built-in AI assistant, and zero-lag calling make this far superior to Telegram or WhatsApp. Highly recommended.", stars: 5 }
  ];
  ...
  return (
    <div className="w-full bg-[#0F172A] text-white selection:bg-[#5B21B6] selection:text-white font-sans overflow-x-hidden">
      ...
      <section className="relative pt-8 pb-20 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left relative">
            ...
            {/* Notification Animators Showcase */}
          ...
          {/* Right Floating Phone Mockup Column */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-1 hover:scale-105 transition-transform">
              <div className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent font-mono">100M+</div>
              <div className="text-xs font-bold uppercase tracking-widest text-gray-400">Total Users</div>
            </div>

            <div className="space-y-1 hover:scale-105 transition-transform">
              <div className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent font-mono">10B+</div>
              <div className="text-xs font-bold uppercase tracking-widest text-gray-400">Secure Messages</div>
            </div>

            <div className="space-y-1 hover:scale-105 transition-transform">
              <div className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-pink-400 to-rose-500 bg-clip-text text-transparent font-mono">190+</div>
              <div className="text-xs font-bold uppercase tracking-widest text-gray-400">Countries</div>
            </div>

            <div className="space-y-1 hover:scale-105 transition-transform">
              <div className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-emerald-400 to-teal-500 bg-clip-text text-transparent font-mono">99.99%</div>
              <div className="text-xs font-bold uppercase tracking-widest text-gray-400">Server Uptime</div>
            </div>
      ...
      <section id="screenshots" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Carousel Preview Content with nice device mockups */}
        <div className="bg-gray-950/40 border border-gray-800 p-6 md:p-10 rounded-[32px] shadow-2xl relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            {/* Selected Tab Screenshot Graphic Mock */}
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="text-left">
              <p className="text-xs font-black uppercase text-pink-400 tracking-wider mb-2">Featured Creators Online</p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              
              {[
                { name: "Hassan Qalli", role: "Vlogger (120k Followers)", avatar: "🇸🇴", balance: "14.2k Coins", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80" },
                { name: "Siraad Ahmed", role: "Chef & Storyteller", avatar: "🇸🇴", balance: "8.9k Coins", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80" },
                { name: "Xamza Cade", role: "Tech Reviewer", avatar: "🇰🇪", balance: "24.1k Coins", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80" },
                { name: "Farxiyo Luul", role: "Artist & Designer", avatar: "🇸🇴", balance: "32.0k Coins", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80" },
              ].map((c, index) => (
      ...
      <footer className="bg-gray-950/80 border-t border-gray-800/80 pt-16 pb-10 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-[11px] text-gray-500 font-bold">
            <p>© {new Date().getFullYear()} {appName} Inc. All rights reserved. Registered under somluul.com.</p>
      ...
      {/* WATCH DEMO POPUP MODAL (SIMULATED TOUR) */}
      <AnimatePresence>
        {demoVideoOpen && (
          <motion.div 
            initial={{ opacity: 0 }}
              ...
              <div className="p-6 text-center space-y-6">
                ...
                <div className="h-64 rounded-2xl bg-gradient-to-br from-[#1e293b] to-[#0f172a] border border-purple-500/10 flex flex-col items-center justify-center space-y-4 relative overflow-hidden">
                  ...
                  <div className="space-y-1.5 z-10">
                    <p className="text-sm font-bold text-white">Simulating App Tour Walkthrough...</p>
                    <p className="text-xs text-gray-400">Loading high-definition streams of Somali creative economies.</p>
                  </div>
                </div>
