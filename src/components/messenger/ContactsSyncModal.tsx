...
export const ContactsSyncModal: React.FC<ContactsSyncModalProps> = ({
  ...
  const [showInviteShare, setShowInviteShare] = useState<MockContact | null>(null);
  const [copiedLink, setCopiedLink] = useState(false);

  // Elegant predefined contacts list representing the user's phonebook
  const mockPhoneBook: MockContact[] = [
    { name: 'Mohamed Mohamud Hassan', phone: '615666561' }, // Matches user's custom target phone!
    { name: 'Khaalid Maxamed Sxb', phone: '+252 61 5112233' }, // Matches preset
    { name: 'Huda Ali Mogadishu', phone: '+252 61 8889900' }, // Matches preset
    { name: 'Abdirahman Warsame', phone: '+252 61 5554433' },
    { name: 'Fardowsa Ibrahim', phone: '+252 61 7771234' },
